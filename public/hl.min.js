...
;hljs.registerLanguage("markdown",e)})();/*! `vim` grammar compiled for Highlight.js 11.6.0 */
...
;hljs.registerLanguage("vim",e)})();/*! `csharp` grammar compiled for Highlight.js 11.6.0 */
(()=>{var e=(()=>{"use strict";return e=>{const n={
...
},a.FUNCTION_DISPATCH]}}})();hljs.registerLanguage("scss",e)})();/*! `vala` grammar compiled for Highlight.js 11.6.0 */
...
className:"meta",begin:"^#",end:"$"}]})})();hljs.registerLanguage("vala",e)})();/*! `rust` grammar compiled for Highlight.js 11.6.0 */
...
;hljs.registerLanguage("ini",e)})();/*! `cmake` grammar compiled for Highlight.js 11.6.0 */
...
;hljs.registerLanguage("cmake",e)})();/*! `kotlin` grammar compiled for Highlight.js 11.6.0 */
(()=>{var e=(()=>{"use strict"
