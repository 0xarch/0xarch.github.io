...
[![](//img.shields.io/badge/原神-弃游-45b6ab)](https://ys.mihoyo.com)  
...
[![Fewu](//img.shields.io/badge/Fewu-3.7-3273d2)](//github.com/fewu-swg/fewu)

[Fewu](//github.com/fewu-swg/fewu) 是一个静态博客生成器，类似于 Hexo，但更加小巧。
Fewu 完全开源！

Fewu 可以在 npm 上下载。包名为 `fewu-cli`，可执行文件名为 `fewu`。

同时，Fewu 有一些配套主题：
* `Next`，类 Fuwari。此主题具有与最新版 Fewu 最好的兼容性。